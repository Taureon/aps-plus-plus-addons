	...
	GUNS: [
		{
			...
			PROPERTIES: {
				AUTOFIRE: true,
				SHOOT_SETTINGS: combineStats([g.basic, g.skimmer, g.lowPower, { reload: 0.5, recoil: 1.35, speed: 1.7, maxSpeed: 1.7 }]),
		...
		},
		{
			...
			PROPERTIES: {
				AUTOFIRE: true,
				SHOOT_SETTINGS: combineStats([g.basic, g.skimmer, { reload: 0.5, speed: 1.7, maxSpeed: 1.7 }]),
				TYPE: ["bullet", {PERSISTS_AFTER_DEATH: true}],
			},
		},
	],
	...
	Class.catapultARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.predator, g.predator, g.predator, { speed: 0.93, maxSpeed: 0.93, reload: 1.333, size: 2 }]),
				TYPE: "bullet",
			},
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.predator, g.predator, g.predator, g.fake, { reload: 1.333 }]),
				TYPE: "bullet",
			},
		},
	)
...
for (let i = 0; i < 4; i++) {
	Class.dartARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.sniper, g.sniper, g.pounder, { reload: 1.5 }]),
				TYPE: "bullet",
			},
		},
		{
	...
	Class.crackerARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.minigun, {reload: 0.85}]),
				TYPE: 'bullet',
			},
		},
		{
	...
	GUNS: [
		{
			POSITION: [22, 10, 1, 0, 0, 0, 0],
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.flankGuard, g.flankGuard, g.autoTurret, {reload: 0.9, recoil: 0.25}]),
				TYPE: "bullet",
			},
		},
	],
	...
	Class.doserARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.shotgun, {health: 1.4, damage: 1.4}]),
				TYPE: 'bullet',
			},
		},
		{
...
for(let i = 0; i < 4; i++) {
	Class.swirlARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.skimmer, { speed: 1.3, maxSpeed: 1.3, reload: 1.333 }]),
	...
	Class.pelterARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, g.artillery, {health: 1.1}]),
				TYPE: "bullet",
				LABEL: "Secondary",
			},
		},
		...
		},
		{
			POSITION: [17, 8, 1, 0, 0, 90*i, 0],
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, {health: 1.1}]),
				TYPE: "bullet",
				LABEL: "Heavy",
			},
		},
	...
	Class.radiationARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.drone, g.overseer, {reload: 0.8}]),
				TYPE: "turretedDrone",
				AUTOFIRE: true,
				SYNCS_SKILLS: true,
				STAT_CALCULATOR: gunCalcNames.drone,
	...
	Class.boxerARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.drone, g.overseer, g.overseer, g.honcho]),
				TYPE: "drone",
				AUTOFIRE: true,
				SYNCS_SKILLS: true,
				STAT_CALCULATOR: gunCalcNames.drone,
	...
	Class.disablerARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.swarm, g.overseer, g.overseer, { reload: 1.5 }]),
				TYPE: "swarm",
...
for(let i = 0; i < 4; i++) {
	Class.shadeARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.hexaTrapper, {range: 0.8, health: 1.2}]),
				TYPE: 'auraTrap',
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.hexaTrapper, g.fake]),
				TYPE: 'bullet',
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
	...
	Class.bayonetARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, g.assassin, g.assassin, {reload: 0.8, density: 0.4}]),
				TYPE: "bullet",
			},
		},
		{
	...
	Class.ballistaARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.predator, g.predator, g.predator, { speed: 0.93, maxSpeed: 0.93, reload: 1.5, health: 1.2, size: 2}]),
				TYPE: "bullet",
			},
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.predator, g.predator, g.predator, g.fake, { reload: 1.5 }]),
				TYPE: "bullet",
			},
		},
	)
...
for (let i = 0; i < 3; i++) {
	Class.barbARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.sniper, g.sniper, g.pounder, { reload: 1.5, damage: 1.2}]),
				TYPE: "bullet",
			},
		},
		{
	...
	GUNS: [
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.autoTurret, g.pelleter, g.power, g.twin, g.tripleShot, {recoil: 0.5}]),
				TYPE: "bullet",
			},
		},
		{
	...
	Class.breakerARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, g.power, g.nailgun, {speed: 1.05, maxSpeed: 1.05}]),
				TYPE: 'bullet',
			},
		},
		{
	...
	GUNS: [
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.autoTurret, g.pelleter, g.twin, g.power, g.flankGuard, g.flankGuard, { speed: 0.7, maxSpeed: 0.7, recoil: 0.25}]),
				TYPE: "bullet",
			},
		},
		{
...
for(let i = 0; i < 3; i++) {
	Class.spiralARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.skimmer, { speed: 1.55, maxSpeed: 1.3, reload: 1.333 }]),
...
for(let i = 0; i < 3; i++) {
	Class.shellerARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.destroyer, g.artillery]),
				TYPE: "bullet",
				LABEL: "Heavy",
			},
		},
	...
	Class.aggressorMinionARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, g.minionGun, { speed: 0.93, maxSpeed: 0.93 }]),
				WAIT_TO_CYCLE: true,
				TYPE: "bullet",
			},
		},
	...
	Class.haloARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.drone, g.overseer, {reload: 1.2, size: 0.8, speed: 1.15, maxSpeed: 1.15}]),
				TYPE: 'turretedDrone',
				AUTOFIRE: true,
				SYNCS_SKILLS: true,
				STAT_CALCULATOR: gunCalcNames.drone,
	...
	Class.sluggerARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.drone, g.overseer, g.honcho, {maxSpeed: 0.9, size: 0.75}]),
				TYPE: "drone",
				AUTOFIRE: true,
				SYNCS_SKILLS: true,
				STAT_CALCULATOR: gunCalcNames.drone,
	...
	Class.debilitatorARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.swarm, g.overseer, g.overseer, {reload: 1.1}]),
				TYPE: "swarm",
				STAT_CALCULATOR: gunCalcNames.swarm,
			},
		},
...
for (let i = 0; i < 3; i++) {
	Class.hydraARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.twin, g.pounder, { speed: 1.2, reload: 1/1.1}]),
				TYPE: "unsetTrap",
			},
		},
	)
...
for(let i = 0; i < 3; i++) {
	Class.sweeperARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				MAX_CHILDREN: 5,
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, { reload: 2.5 }]),
				TYPE: 'unsetPillbox',
				SYNCS_SKILLS: true,
...
for(let i = 0; i < 3; i++) {
	Class.aegisARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.hexaTrapper, {range: 0.8, health: 1.2}]),
				TYPE: 'auraBlock',
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.hexaTrapper, g.fake]),
				TYPE: 'bullet',
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
...
for(let i = 0; i < 3; i++) {
	Class.drillARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.hexaTrapper]),
				TYPE: 'unsetTrap',
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
	...
	Class.tempestTurretARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.drone, g.overseer, {size: 1.4}]),
				TYPE: ['drone', {INDEPENDENT: true}],
				AUTOFIRE: true,
				SYNCS_SKILLS: true,
				STAT_CALCULATOR: gunCalcNames.drone,
	...
	GUNS: [
		{
			...
			PROPERTIES: {
				MAX_CHILDREN: 5,
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, {maxSpeed: 1e-3, speed: 1e-3}]),
				TYPE: 'unsetPillbox',
				INDEPENDENT: true,
				SYNCS_SKILLS: true,
				DESTROY_OLDEST_CHILD: true,
	...
	Class.javelinARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, g.assassin, g.assassin, g.assassin, {reload: 0.8, density: 0.22}]),
				TYPE: "bullet",
			},
		},
		{
	...
	Class.trebuchetARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.predator, g.predator, g.predator, g.predator, { speed: 0.93, maxSpeed: 0.93, reload: 1.5, health: 1.4, size: 2}]),
				TYPE: "bullet",
			},
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.predator, g.predator, g.predator, g.predator, g.fake, { reload: 1.5 }]),
				TYPE: "bullet",
			},
		},
	)
...
for (let i = 0; i < 5; i++) {
	Class.boltARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.sniper, g.sniper, g.pounder, { reload: 1.5, damage: 1.2, speed: 1.2, maxSpeed: 1.2}]),
				TYPE: "bullet",
			},
		},
		{
	...
	GUNS: [
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, g.flankGuard, g.flankGuard, g.autoTurret]),
				TYPE: "bullet",
			},
		},
		{
	...
	Class.eroderARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.minigun, {health: 1.1}]),
				TYPE: 'bullet',
			},
		},
		{
	...
	GUNS: [
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.flankGuard, g.flankGuard, g.autoTurret, {reload: 0.9, recoil: 0.25}]),
				TYPE: "bullet",
			},
		},
	],
	...
	Class.anesthesiologistARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.shotgun, {reload: 1.2, health: 1.4, damage: 1.4}]),
				TYPE: 'bullet',
			},
		},
		{
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.shotgun, { speed: 1.55, maxSpeed: 1.3, reload: 1.2}]),
				TYPE: 'bullet',
			},
		},
		{
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.shotgun, g.fake, {reload: 1.2}]),
				TYPE: 'casing',
			},
		},
		{
...
for(let i = 0; i < 5; i++) {
	Class.helixARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.artillery, g.artillery, g.skimmer, { speed: 1.85, maxSpeed: 1.3, reload: 1.333 }]),
				TYPE: "spiralMissileARDreadV2",
				STAT_CALCULATOR: gunCalcNames.sustained,
			},
		},
	...
	Class.bombardmentARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, g.artillery, {speed: 1.1, maxSpeed: 1.1}]),
				TYPE: "bullet",
				LABEL: "Secondary",
			},
		},
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.destroyer, g.artillery, {speed: 1.1, maxSpeed: 1.1}]),
				TYPE: "bullet",
				LABEL: "Heavy",
			},
		},
	...
	Class.starlightARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.drone, g.overseer, {reload: 1.5, speed: 1.15, maxSpeed: 1.15}]),
				TYPE: 'turretedDrone',
				AUTOFIRE: true,
				SYNCS_SKILLS: true,
				STAT_CALCULATOR: gunCalcNames.drone,
	...
	Class.bruiserARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.drone, g.overseer, g.overseer, g.honcho, {maxSpeed: 0.85}]),
				TYPE: "drone",
				AUTOFIRE: true,
				SYNCS_SKILLS: true,
				STAT_CALCULATOR: gunCalcNames.drone,
	...
	Class.incapacitatorARDreadV2.GUNS.push(
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.swarm, g.overseer, g.overseer, g.overseer, {reload: 1.15}]),
				TYPE: "swarm",
				STAT_CALCULATOR: gunCalcNames.swarm,
			},
		},
...
for (let i = 0; i < 5; i++) {
	Class.cerberusARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.pounder, { speed: 1.2, reload: 1.09}]),
				TYPE: "trap",
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.pounder, { speed: 1.2, reload: 1.09}]),
				TYPE: "unsetTrap",
			},
		},
	)
...
for(let i = 0; i < 5; i++) {
	Class.sterilizerARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				MAX_CHILDREN: 5,
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, { reload: 2.667 }]),
				TYPE: 'unsetPillbox',
				SYNCS_SKILLS: true,
				DESTROY_OLDEST_CHILD: true,
				INDEPENDENT: true,
...
for(let i = 0; i < 5; i++) {
	Class.hielamanARDreadV2.GUNS.push(
		...
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.hexaTrapper, {reload: 1.2, range: 0.8, health: 1.2}]),
				TYPE: 'auraBlock',
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.hexaTrapper, g.fake, {reload: 1.2}]),
				TYPE: 'bullet',
				STAT_CALCULATOR: gunCalcNames.trap,
			},
		},
...
if (useOldPhotosphere) {
	Class.photosphereSmallAuraARV2 = addAura(1, 1.85, 0.15);
	...
	GUNS: [
		{
			...
			PROPERTIES: {
				MAX_CHILDREN: 5,
				SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.construct, {maxSpeed: 1e-3, speed: 1e-3}]),
				TYPE: 'unsetPillbox',
				INDEPENDENT: true,
				SYNCS_SKILLS: true,
				DESTROY_OLDEST_CHILD: true,
